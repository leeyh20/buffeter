...
class Buffet(models.Model):
    ...
    hrs_opening = models.TimeField(help_text="")
    hrs_closing = models.TimeField(help_text="")
    phone_number = models.CharField(max_length=20, null=True)
    address = models.CharField(max_length=100, null=True)
    
    weekday_adult_breakfast_price = models.FloatField(blank=True, null=True)
    weekday_adult_lunch_price = models.FloatField(null=True)
    weekday_adult_hightea_price = models.FloatField(blank=True, null=True)
    weekday_adult_dinner_price = models.FloatField(null=True)

    weekday_child_breakfast_price = models.FloatField(blank=True, null=True)
    weekday_child_lunch_price = models.FloatField(blank=True, null=True)
    weekday_child_hightea_price = models.FloatField(blank=True, null=True)
    weekday_child_dinner_price = models.FloatField(blank=True, null=True)

    weekend_adult_breakfast_price = models.FloatField(blank=True, null=True)
    weekend_adult_lunch_price = models.FloatField(null=True)
    weekend_adult_hightea_price = models.FloatField(blank=True, null=True)
    weekend_adult_dinner_price = models.FloatField(null=True)

    weekend_child_breakfast_price = models.FloatField(blank=True, null=True)
    weekend_child_lunch_price = models.FloatField(blank=True, null=True)
    weekend_child_hightea_price = models.FloatField(blank=True, null=True)
    weekend_child_dinner_price = models.FloatField(blank=True, null=True)
